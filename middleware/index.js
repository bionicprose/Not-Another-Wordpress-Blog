...
//multer config from Jesse Lewis @ https://medium.com/@Moonstrasse/how-to-make-a-basic-html-form-file-upload-using-multer-in-an-express-node-js-app-16dac2476610

 middlewareObj.multerConfig = {
  ...
  middlewareObj.multerProfilePic = {
    limits: { fieldSize: 25 * 1024 * 1024,
            fileSize: 50000 },
    storage: multer.diskStorage({
      destination: function(req, file, next) {
